...
VALUES (1, 3, 1746641342, 'pending'),
       (2, 5, 1746641343, 'closed'),
       (3, 3, 1746641344, 'pending'),
       (4, 4, 1746641345, 'closed'),
       (5, 4, 1746641346, 'pending'),
       (6, 3, 1746641347, 'closed'),
       (7, 8, 1746641348, 'pending'),
       (8, 2, 1746641349, 'closed'),
       (9, 7, 1746641350, 'pending'),
       (10, 6, 1746641351, 'closed'),
       (11, 9, 1746641352, 'pending'),
       (12, 4, 1746641352, 'closed'),
       (13, 1, 1746641353, 'pending'),
       (14, 10, 1746641354, 'closed'),
       (4, 8, 1746641355, 'pending');

INSERT INTO Message (senderId, receiverId, content, date)
VALUES (3, 2, 'Please give me a discount.', 1746641342),
       (2, 3, 'No.', 1746642342),
       (5, 4, 'I love your designs!', 1746641342),
       (4, 5, 'Thank you!', 1746642342),
       (3, 5, 'Can you optimize my site?', 1746641342),
       (5, 3, 'Sure, let’s discuss details.', 1746642342),
       (4, 2, 'Need an article on tech trends.', 1746641342),
       (2, 4, 'I can help.', 1746642342),
       (4, 6, 'Can you create a custom illustration?', 1746641342),
       (6, 4, 'Sure, I will send you the draft soon.', 1746642342),
       (3, 7, 'I need a website redesign.', 1746641342),
       (7, 3, 'I have some ideas; let me know your requirements.', 1746642342),
       (8, 9, 'Interested in your photography service.', 1746641342),
       (9, 8, 'I will schedule a session soon.', 1746642342),
       (2, 10, 'Looking for video editing, can you help?', 1746641342),
       (10, 2, 'Yes, I can edit your video professionally.', 1746642342),
       (5, 7, 'Do you offer social media marketing packages?', 1746641342),
       (7, 5, 'Yes, let me send you the details.', 1746642342);

INSERT INTO Feedback (purchaseId, rating, review, date)
VALUES (1, 2.1, 'Very good', 1746641342),
       (2, 4.5, 'Excellent work', 1746641342),
       (3, 3.0, 'Satisfactory', 1746641342),
       (4, 4.0, 'Great job', 1746641342),
       (5, 4.2, 'Very creative illustrations!', 1746641342),
       (6, 3.8, 'Website design met my expectations.', 1746641342),
       (7, 5.0, 'Amazing portrait photography!', 1746641342),
       (8, 4.7, 'Video editing was top-notch.', 1746641342),
       (9, 3.5, 'Social media marketing showed good results.', 1746641342),
       (9, 4.0, 'Service was professional and prompt.', 1746641342),
       (10, 4.0, 'Podcast editing was clear and concise.', 1746641342),
       (11, 4.3, 'Voice over was professional and engaging.', 1746641342),
       (12, 4.8, 'Full stack development exceeded expectations.', 1746641342),
       (13, 3.9, 'Business card design was neat and creative.', 1746641342),
       (14, 4.2, 'The email campaign delivered excellent ROI.', 1746641342),
       (15, 4.5, 'The article writing provided insightful content.', 1746641342);
