        ...
        <div class="service-detail-layout">
            <div class="service-detail-left">
                <div class="freelancer-info">
                    <img class="freelancer-pic" src="<?= htmlspecialchars($service_freelancer['freelancer']['profilePictureURL']) ?>" alt="">
                ...
                <div class="service-price-box-inline">
                    ...
                    <a href="/pages/checkout.php?serviceId=<?= $service_freelancer['serviceId'] ?>" class="purchase-btn">Purchase</a>
                    <a href="/pages/chat.php?user_id=<?= $service_freelancer['freelancer']['id'] ?>" class="service-contact-btn">Contact me</a>
                </div>
            </div>
    ...
    <section class="service-detail-section">
        <div class="service-detail-layout">
            <div class="service-detail-left">
                ...
                <div class="service-price-box-inline">
                    <p class="price-amount editable" data-field="price">€<span class="price-value"><?= $service_freelancer['price'] ?></span></p>
                    <a href="/pages/checkout.php?serviceId=<?= $service_freelancer['serviceId'] ?>" class="purchase-btn">Purchase</a>
                    <a href="/pages/chat.php?user_id=<?= $service_freelancer['freelancer']['id'] ?>" class="service-contact-btn">Contact me</a>
