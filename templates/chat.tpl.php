...
function drawChat(User $user, User $otherUser, array $history, Session $session): void
{
        ...
        <div class="chat-container">
            ...
            <form id="chat-form">
                ...
                <input type="hidden" id="receiver-id" name="receiver_id"
                       value="<?= htmlspecialchars((string)$otherUser->getId()) ?>">
                <textarea id="message-content" name="msg_content" rows="3" placeholder="Type your message..."
                          required></textarea>
